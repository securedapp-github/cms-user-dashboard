      ...
      <div className="space-y-6 py-2">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2 px-1">
            ...
            <h4 className="text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Requested Data & Purpose</h4>
          </div>
          <div className="p-5 rounded-2xl border border-[#e2e8f0] bg-white space-y-4">
            <div>
              <h5 className="text-sm font-bold text-[#0f172a]">{purpose.name}</h5>
              <p className="text-xs text-[#64748b] mt-1 line-clamp-2">{purpose.description}</p>
            </div>
            
            <div className="pt-4 border-t border-[#f1f5f9]">
              <p className="text-[10px] text-[#94a3b8] font-bold uppercase mb-2">Requested Data Attributes</p>
              <div className="flex flex-wrap gap-1.5">
                {purpose.data_items.map((item) => (
